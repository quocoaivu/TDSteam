...
{
	public class JoinClusterSwitchHandler : FreeResourcesSwitchHandler
	{
		...
		private void SetGemData()
		{
			...
			//gemAmount.text = "+ " + NativeSpecificServicesSource.Services.FacebookServices.GetFreeResources("reward_id_join_group").ToString();
		}

		public override void OnClick()
		{
			base.OnClick();
			//NativeSpecificServicesSource.Services.FacebookServices.InviteToGroup();
			InitData();
		}
