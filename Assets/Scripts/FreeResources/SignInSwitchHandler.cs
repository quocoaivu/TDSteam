...
{
	public class SignInSwitchHandler : FreeResourcesSwitchHandler
	{
		...
		private void SetGemData()
		{
			...
			//gemAmount.text = "+ " + NativeSpecificServicesSource.Services.FacebookServices.GetFreeResources("reward_id_login").ToString();
		}

		public override void OnClick()
		{
			base.OnClick();
			//NativeSpecificServicesSource.Services.FacebookServices.LogIn();
			InitData();
		}
