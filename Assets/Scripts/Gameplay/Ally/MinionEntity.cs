...
namespace Gameplay
{
	public class MinionEntity : CharacterEntity
	{
		...
		public void InitFromTower(TurretSpec _towerParameter, TurretSummonMinionHandler _towerSpawnAllyController)
		{
			...
			AttackRangeMin = (float)towerParameter.unit_attack_range_min / GameRecord.PIXEL_PER_UNIT;
			AttackRangeAverage = (float)towerParameter.unit_attack_range_average / GameRecord.PIXEL_PER_UNIT;
			AttackRangeMax = (float)towerParameter.unit_attack_range_max / GameRecord.PIXEL_PER_UNIT;
			CurrentAttackRangeMax = AttackRangeMax;
			moveSpeed = (float)towerParameter.unit_moveSpeed;
