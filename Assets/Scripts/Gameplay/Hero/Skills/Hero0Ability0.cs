...
namespace Gameplay
{
	public class Hero0Ability0 : HeroAbilityShared
	{
        ...
        public override void Init(HeroEntity heroModel)
		{
			...
			heroSkillParameter_0_ = (HeroAbilitySpec_0_0)HeroAbilitySpec.Instance.GetHeroSkillsParameter(heroID, skillID);
			...
			MonoSingleton<AllyPool>.Instance.PushAlliesToPool(100, 100, 0);
		}
		...
		private void CreateClones(Vector2 targetPosition)
		{
			...
			{
				MinionEntity allyModel = MonoSingleton<AllyPool>.Instance.GetAlly(100, 100);
			...
			MonoSingleton<GameplayUIHeroDirector>.Instance.listSelectHeroSkillButton[0].DoCooldown();
		}
	}
}
