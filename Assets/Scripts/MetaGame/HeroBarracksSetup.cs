...
namespace MetaGame
{
	public class HeroBarracksSetup
	{
        private static HeroBarracksSetup instance;
        ...
        public static HeroBarracksSetup Instance
		{
			get
			{
				if (HeroBarracksSetup.instance == null)
				{
					HeroBarracksSetup.instance = new HeroBarracksSetup();
				}
				return HeroBarracksSetup.instance;
			}
		}
