...
{
    public class AdvertAndroid : MonoBehaviour, IAdvert
    {
        private void Start()
        {
            InitAds();
        ...
        {
            return Bootstrap.GameBootstrap.Instance.RemoteConfig.ChanceToShowInterAds_EndGame() > 0 || Bootstrap.GameBootstrap.Instance.RemoteConfig.ChanceToShowInterAds_Loading() > 0;
        }
