...
{
	public class MetricsAndroid : MonoBehaviour, IMetrics
	{
		...
		public void SendEvent_BuyItem(string productID)
		{
			...
			NativeSpecificServicesSource.Services.UserProfile.TakePremiumUserInfor();
		}
		...
		public void SendEvent_GetFreeResourcesComplete(FreeResourcesKind freeResourcesType, int currentMapIDUnlocked)
		{
