...
namespace Services.PlatformSpecific
{
	public interface IMetrics
	{
		...
		void SendEvent_ShareLinkGameComplete(StageTag sceneName, int mapID);

		void SendEvent_GetFreeResourcesComplete(FreeResourcesKind freeResourcesType, int currentMapIDUnlocked);

		void SendEvent_FreeChestOffer(int mapID, FreeCrateDealKind type, int offerCount);
