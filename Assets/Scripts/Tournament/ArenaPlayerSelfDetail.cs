...
public class ArenaPlayerSelfDetail
{
	public ArenaPlayerSelfDetail(int curgroupid, int curtier, int lastgroupid, int recFriendReward, int recSeasonReward, string name, int score, int lastscore, int heroesCode, string country, bool tierup)
	{
