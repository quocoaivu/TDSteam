  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: 
    {
      ...
      OUT_Data_Vert vert(IN_Data_Vert in_v)
      {
          ...
          out_v.xlv_TEXCOORD0 = in_v.in_TEXCOORD0.xy;
      ...
      OUT_Data_Frag frag(IN_Data_Frag in_f)
      {
          ...
          float4 tmpvar_3;
          tmpvar_3.xyz = max(float3(_TextureFade, _TextureFade, _TextureFade), tmpvar_2.xyz);
          tmpvar_3.w = tmpvar_2.w;
          tmpvar_1 = ((tmpvar_3 * in_f.xlv_COLOR) * (_Color * tmpvar_2.w));
